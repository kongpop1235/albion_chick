      ...
      <v-row class="ma-0">
          ...
          <v-card-text class="d-flex align-center my-0 py-0 pl-2">
            ...
            <div class="text_list">
              <p class="primary--text mb-1">
                <span class="primary--text">{{ b_item_name_1 }}</span>
              </p>
              <p class="mb-1">
                BUY : <span :style="b_city_buy_color_1">{{ b_city_buy_1 }}</span>
              </p>
              <p class="mb-1">
                SELL : <span :style="b_city_sell_color_1">{{ b_city_sell_1 }}</span>
              </p>
            </div>
            <v-spacer></v-spacer>
        ...
        <v-col cols="12" class="py-a">
          <v-card-text class="d-flex align-center my-0 py-0 pl-2">
            ...
            <div class="text_list">
              <p class="primary--text mb-1">
                <span class="primary--text">{{ b_item_name_2 }}</span>
              </p>
              <p class="mb-1">
                BUY : <span :style="b_city_buy_color_2">{{ b_city_buy_2 }}</span>
              </p>
              <p class="mb-1">
                SELL : <span :style="b_city_sell_color_2">{{ b_city_sell_2 }}</span>
              </p>
            </div>
            <v-spacer></v-spacer>
            <div class="green--text mb-2 mr-2 text-right">
...
export default {
  ...
  methods: {
    action() {
      this.$store.getters.Detail[0] = "Bridgewatch";
